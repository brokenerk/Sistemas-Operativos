/*
    Descripción: Programa que crea una serie aleatoria de archivos en un ruta especifica
                 introducida a través de la linea de comandos, y que muestra tamaño, fecha
                 y hora de creación de dichos archivos.
*/
#include <windows.h>
#include <time.h>
#include <errno.h>
...
// Función que escribe archivos con el contenido establecido
void escribirArchivo(HANDLE harchivo, char content[10][1000], int k, int r, char* ruta)
{
    ...
    for(j=0 ; j<r*5 ; j++) // Escribimos 5 veces el texto en el archivo
	{
		...
		BOOL escribir = WriteFile( 
                    ...
                    &bytesEscritos, 			// Tamaño de bytes escritos
                    NULL);           			// No overlapped structure

        // Si se escribio correctamente el archivo
    	if(escribir)
    	{
...
int main(int argc, const char *argv[])
{
    ...
    */
    ...
    else
    {
    	...
    	for(i=0; i<random; i++)
    	{
            /*
                ...
                Damos formato de cadena y concatenamos el numero de archivo generado 
                por el ciclo y agregamos la extension TXT.
            */
    		strcpy(dir, path);
    ...
    /*
       MOSTRAR CARACTERISTICAS DE CADA ARCHIVO 
    */
        printf("\nLOS ARCHIVOS SON:\n");
